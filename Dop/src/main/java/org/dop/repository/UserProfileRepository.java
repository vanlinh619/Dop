...
public interface UserProfileRepository extends JpaRepository<UserProfile, UUID> {
    ...
    @Query("""
            select new org.dop.module.manageuser.pojo.projection.UserConsentProjection(up.fullName)
            from UserProfile up
            where up.id = :id
            """)
    ...
    @Query("""
            select new org.dop.module.manageuser.pojo.projection.ProfileUserInfoProjection(
    ...
    @Query("""
            select new org.dop.module.manageuser.pojo.projection.AddressUserInfoProjection(
    ...
    @Query("""
            select new org.dop.module.manageuser.pojo.projection.PhoneUserInfoProjection(
                up.phone.number,
                up.phone.verified
            )
            from UserProfile up
